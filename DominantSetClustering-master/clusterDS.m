...
if ~exist('epsilon','var')
    %epsilon = 0.0001; for 3 Gaussian clusters
    %epsilon=0.000001; % for 15 Gaussian clusters
    epsilon=0.00001 ; % for a 1
    %epsilon=0.002; % for 2 Gaussian clusters  
    %epsilon=0.0001; % for s3
end
...
while ~isempty(remaining)
    ...
    [x, iter_no] = replicator_dynamics_optimization(x,currentA,iter_thresh, epsilon);
    nSets = nSets+1;
